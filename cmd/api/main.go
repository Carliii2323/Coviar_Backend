...
func main() {
	...
	cuentaService := service.NewCuentaService(cuentaRepo, bodegaRepo, responsableRepo)
	...
	// Rutas estáticas antes de las dinámicas para evitar conflicto con {id_autoevaluacion}
